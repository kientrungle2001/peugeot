...
export const CmsPostPageList = (props) => (
    <List {...props} filters={<CmsPostPageFilter />}>
        <Datagrid>
            <TextField source="id" />
...
const CmsPostPageTitle = ({ record }) => {
    return <span>Post {record ? `"${record.title}"` : ''}</span>;
};

export const CmsPostPageEdit = (props) => (
    <Edit title={<CmsPostPageTitle />} {...props}>
        <TabbedForm>
...
export const CmsPostPageCreate = (props) => (
    <Create {...props}>
        <TabbedForm>
            <FormTab label="Tổng quan">
                <TextInput source="title" label="Tiêu đề" className="ra-field-33" />
...
export const CmsPostPageShow = (props) => (
    <Show title={<CmsPostPageTitle />} {...props}>
        <TabbedShowLayout>
            <Tab label="Tổng quan">
