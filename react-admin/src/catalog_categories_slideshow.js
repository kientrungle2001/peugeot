...
const CatalogCategorySlideshowFilter = (props) => (
    <Filter {...props}>
        <TextInput label="Tìm kiếm" source="q" alwaysOn />
        <TextInput label="Ứng dụng" source="software_id" />
        <TextInput label="Website" source="site_id" />
        <ReferenceInput label="Danh mục cha" source="parent_id" reference="catalog_categories_root" allowEmpty={true}>
            <AutocompleteInput optionText="title" optionValue="id" allowEmpty={true} />
        </ReferenceInput>
    </Filter>
);

export const CatalogCategorySlideshowList = (props) => (
    <List {...props} filters={<CatalogCategorySlideshowFilter />}>
        <Datagrid>
            <TextField source="id" />
            <TextField source="title" label="Tiêu đề" />
            <ReferenceField label="Danh mục cha" source="parent_id" reference="catalog_categories_root">
...
const CatalogCategorySlideshowTitle = ({ record }) => {
    return <span>Danh mục: {record ? `"${record.title}"` : ''}</span>;
};

export const CatalogCategorySlideshowEdit = (props) => (
    <Edit title={<CatalogCategorySlideshowTitle />} {...props}>
        <TabbedForm>
            <FormTab label="Tổng quan">
                ...
                <ReferenceInput label="Danh mục cha" source="parent_id" reference="catalog_categories_root" allowEmpty={true} className="ra-field-33">
...
export const CatalogCategorySlideshowCreate = (props) => (
    <Create {...props}>
        <TabbedForm>
            <FormTab label="Tổng quan">
                <TextInput source="type" label="Loại" className="ra-field-33" />
...
export const CatalogCategorySlideshowShow = (props) => (
    <Show title={<CatalogCategorySlideshowTitle />} {...props}>
        <TabbedShowLayout>
            <Tab label="Tổng quan">
                ...
                <ReferenceField label="Danh mục cha" source="parent_id" reference="catalog_categories_root" className="ra-field-33">
                    <TextField source="title" />
                </ReferenceField>
