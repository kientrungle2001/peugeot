...
const CatalogCategorySlideFilter = (props) => (
    <Filter {...props}>
        <TextInput label="Tìm kiếm" source="q" alwaysOn />
        <TextInput label="Ứng dụng" source="software_id" />
        <TextInput label="Website" source="site_id" />
        <ReferenceInput label="Danh mục cha" source="parent_id" reference="catalog_categories_slideshow" allowEmpty={true}>
            <AutocompleteInput optionText="title" optionValue="id" allowEmpty={true} />
        </ReferenceInput>
    </Filter>
);

export const CatalogCategorySlideList = (props) => (
    <List {...props} filters={<CatalogCategorySlideFilter />}>
        <Datagrid>
            <TextField source="id" />
            <ImageField source="image" label="Ảnh" />
            <TextField source="title" label="Tiêu đề" />
            <ReferenceField label="Danh mục cha" source="parent_id" reference="catalog_categories_slideshow">
...
const CatalogCategorySlideTitle = ({ record }) => {
    return <span>Danh mục: {record ? `"${record.title}"` : ''}</span>;
};

export const CatalogCategorySlideEdit = (props) => (
    <Edit title={<CatalogCategorySlideTitle />} {...props}>
        <TabbedForm>
            <FormTab label="Tổng quan">
                ...
                <ReferenceInput label="Danh mục cha" source="parent_id" reference="catalog_categories_slideshow" allowEmpty={true} className="ra-field-33">
...
export const CatalogCategorySlideCreate = (props) => (
    <Create {...props}>
        <TabbedForm>
            <FormTab label="Tổng quan">
                <TextInput source="type" label="Loại" className="ra-field-33" />
...
export const CatalogCategorySlideShow = (props) => (
    <Show title={<CatalogCategorySlideTitle />} {...props}>
        <TabbedShowLayout>
            <Tab label="Tổng quan">
                ...
                <ReferenceField label="Danh mục cha" source="parent_id" reference="catalog_categories_slideshow" className="ra-field-33">
                    <TextField source="title" />
                </ReferenceField>
