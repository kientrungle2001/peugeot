...
const CatalogCategoryProductFilter = (props) => (
    <Filter {...props}>
...
export const CatalogCategoryProductList = (props) => (
    <List {...props} filters={<CatalogCategoryProductFilter />}>
        <Datagrid>
            <TextField source="id" />
...
const CatalogCategoryProductTitle = ({ record }) => {
    return <span>Danh mục: {record ? `"${record.title}"` : ''}</span>;
};

export const CatalogCategoryProductEdit = (props) => (
    <Edit title={<CatalogCategoryProductTitle />} {...props}>
        <TabbedForm>
...
export const CatalogCategoryProductCreate = (props) => (
    <Create {...props}>
        <TabbedForm>
            <FormTab label="Tổng quan">
                <TextInput source="type" label="Loại" className="ra-field-33" />
...
export const CatalogCategoryProductShow = (props) => (
    <Show title={<CatalogCategoryProductTitle />} {...props}>
        <TabbedShowLayout>
            <Tab label="Tổng quan">
