...
const CatalogCategoryMenuFilter = (props) => (
    <Filter {...props}>
...
export const CatalogCategoryMenuList = (props) => (
    <List {...props} filters={<CatalogCategoryMenuFilter />}>
        <Datagrid>
            <TextField source="id" />
...
const CatalogCategoryMenuTitle = ({ record }) => {
    return <span>Danh mục: {record ? `"${record.title}"` : ''}</span>;
};

export const CatalogCategoryMenuEdit = (props) => (
    <Edit title={<CatalogCategoryMenuTitle />} {...props}>
        <TabbedForm>
...
export const CatalogCategoryMenuCreate = (props) => (
    <Create {...props}>
        <TabbedForm>
            <FormTab label="Tổng quan">
                <TextInput source="type" label="Loại" className="ra-field-33" />
...
export const CatalogCategoryMenuShow = (props) => (
    <Show title={<CatalogCategoryMenuTitle />} {...props}>
        <TabbedShowLayout>
            <Tab label="Tổng quan">
