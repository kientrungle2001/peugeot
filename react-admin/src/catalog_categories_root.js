...
const CatalogCategoryRootFilter = (props) => (
    <Filter {...props}>
...
export const CatalogCategoryRootList = (props) => (
    <List {...props} filters={<CatalogCategoryRootFilter />}>
        <Datagrid>
            <TextField source="id" />
...
const CatalogCategoryRootTitle = ({ record }) => {
    return <span>Danh mục: {record ? `"${record.title}"` : ''}</span>;
};

export const CatalogCategoryRootEdit = (props) => (
    <Edit title={<CatalogCategoryRootTitle />} {...props}>
        <TabbedForm>
...
export const CatalogCategoryRootCreate = (props) => (
    <Create {...props}>
        <TabbedForm>
            <FormTab label="Tổng quan">
                <TextInput source="type" label="Loại" className="ra-field-33" />
...
export const CatalogCategoryRootShow = (props) => (
    <Show title={<CatalogCategoryRootTitle />} {...props}>
        <TabbedShowLayout>
            <Tab label="Tổng quan">
