...
import { ImageField } from 'ra-ui-materialui/lib/field';
...
const CatalogCategoryProductTypeFilter = (props) => (
    <Filter {...props}>
        <TextInput label="Tìm kiếm" source="q" alwaysOn />
        <TextInput label="Ứng dụng" source="software_id" />
        <TextInput label="Website" source="site_id" />
        <ReferenceInput label="Danh mục cha" source="parent_id" reference="catalog_categories_product" allowEmpty={true}>
            <AutocompleteInput optionText="title" optionValue="id" allowEmpty={true} />
        </ReferenceInput>
    </Filter>
);

export const CatalogCategoryProductTypeList = (props) => (
    <List {...props} filters={<CatalogCategoryProductTypeFilter />}>
        <Datagrid>
            <TextField source="id" />
...
const CatalogCategoryProductTypeTitle = ({ record }) => {
    return <span>Danh mục: {record ? `"${record.title}"` : ''}</span>;
};

export const CatalogCategoryProductTypeEdit = (props) => (
    <Edit title={<CatalogCategoryProductTypeTitle />} {...props}>
        <TabbedForm>
...
export const CatalogCategoryProductTypeCreate = (props) => (
    <Create {...props}>
        <TabbedForm>
            <FormTab label="Tổng quan">
                <TextInput source="type" label="Loại" className="ra-field-33" />
...
export const CatalogCategoryProductTypeShow = (props) => (
    <Show title={<CatalogCategoryProductTypeTitle />} {...props}>
        <TabbedShowLayout>
            <Tab label="Tổng quan">
