...
const CatalogCategoryMenuItemFilter = (props) => (
    <Filter {...props}>
        <TextInput label="Tìm kiếm" source="q" alwaysOn />
        <TextInput label="Ứng dụng" source="software_id" />
        <TextInput label="Website" source="site_id" />
        <ReferenceInput label="Danh mục cha" source="parent_id" reference="catalog_categories_menu" allowEmpty={true}>
            <AutocompleteInput optionText="title" optionValue="id" allowEmpty={true} />
        </ReferenceInput>
    </Filter>
);

export const CatalogCategoryMenuItemList = (props) => (
    <List {...props} filters={<CatalogCategoryMenuItemFilter />}>
        <Datagrid>
            <TextField source="id" />
            <TextField source="title" label="Tiêu đề" />
            <ReferenceField label="Danh mục cha" source="parent_id" reference="catalog_categories_menu">
...
const CatalogCategoryMenuItemTitle = ({ record }) => {
    return <span>Danh mục: {record ? `"${record.title}"` : ''}</span>;
};

export const CatalogCategoryMenuItemEdit = (props) => (
    <Edit title={<CatalogCategoryMenuItemTitle />} {...props}>
        <TabbedForm>
            <FormTab label="Tổng quan">
                ...
                <ReferenceInput label="Danh mục cha" source="parent_id" reference="catalog_categories_menu" allowEmpty={true} className="ra-field-33">
...
export const CatalogCategoryMenuItemCreate = (props) => (
    <Create {...props}>
        <TabbedForm>
            <FormTab label="Tổng quan">
                <TextInput source="type" label="Loại" className="ra-field-33" />
...
export const CatalogCategoryMenuItemShow = (props) => (
    <Show title={<CatalogCategoryMenuItemTitle />} {...props}>
        <TabbedShowLayout>
            <Tab label="Tổng quan">
                ...
                <ReferenceField label="Danh mục cha" source="parent_id" reference="catalog_categories_menu" className="ra-field-33">
                    <TextField source="title" />
                </ReferenceField>
